...
> **W1：与现有方法的设计差异（论文：Table 5, Def. 1）**None
以下对比表阐明关键架构区别：
...
> **W2：Plug-and-play 并非"纯工程"（新增：Tables R2–R4 | 论文：Prop. 1, Table 7）**None
...
> **W3/Q1：CWRPO vs. GRPO——三个目标函数层面的差异（论文：Table 6, Prop. 6）**None
...
> **W4：Reward 组件消融（新增：Table R1 | 论文：Tables 5, 6）**None
