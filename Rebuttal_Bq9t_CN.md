...
**W1：与现有方法的设计差异** *(论文：Table 5, Def. 1, 附录 E)*
...
**W2：Plug-and-play 并非"纯工程"** *(新增：表 R2–R4 | 论文：Proposition 1)*
...
**W3/Q1：CWRPO vs. GRPO——三个目标函数层面的差异** *(论文：Proposition 6, Table 6)*
...
**W4：Reward 组件消融** *(新增：表 R1 | 论文：Tables 5, 6)*
