...
Our new transfer experiments (supplementary **Tables R2–R4**) empirically validate this: removing operators causes task-specific degradation (−Verify/Test: APPS −14.05, DS-1000 −20.31; −ScEnsemble/Aggregate: AIME −6.67), confirming each group's distinct role; substitution with unseen implementations yields near-lossless performance (avg. IID +0.3 / OOD +0.1); and adding entirely new operators shows selective improvement without non-target degradation (+Search: TriviaQA/NQ +5.47/+8.59 EM; +Debugger: APPS/DS-1000 +2.35/+3.91).
...
Importantly, our new sensitivity analysis (supplementary **Table R5**) shows this distinction has limited practical impact: equal weighting (0.25×4) achieves IID 82.29 / OOD 55.58; checker-heavy (0.4/0.2/0.2/0.2) achieves IID 82.94 / OOD 54.41 — vs. default IID 85.15 / OOD 59.59. All 5 configurations show gradual degradation (IID −2.21 to −4.42) without catastrophic failure. All weight configurations with sum=1.0 preserve the conditional release mechanism (Eq. 14).
