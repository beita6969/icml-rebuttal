...
**W1: Operator library scalability with overlapping tools** *(New: Tables R2–R4 | Paper: Propositions 1, 4, Table 7)*
...
**W3: Weight inconsistency between Appendix C.1 and Table 11** *(New: Table R5 | Paper: Table 11, Appendix C.1)*
