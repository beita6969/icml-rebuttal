...
**W1: Design differences from existing methods** *(Paper: Table 5, Def. 1, Appendix E)*
...
**W2: Plug-and-play is not "pure engineering"** *(New: Tables R2–R4 | Paper: Proposition 1)*
...
**W3/Q1: CWRPO vs. GRPO — three objective-level differences** *(Paper: Proposition 6, Table 6)*
