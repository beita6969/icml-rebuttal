...
**W1/Q1: Theoretical grounding and reward stability** *(New: Tables R1, R5 | Paper: Proposition 3, Appendix B.2)*
...
**W2/Q2: Ablation granularity — disentangling contributions** *(New: Table R1 | Paper: Tables 3, 5, 6)*
...
**W3/Q3: Positioning relative to RL-based agentic methods** *(Paper: Appendix E Table 12, Proposition 2)*
...
**Q5: Cross-backend generalization** *(New: Tables R2–R4 | Paper: Figure 4, Section 5.3)*
